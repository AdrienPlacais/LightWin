...
class FieldMap100(FieldMap):
    ...
    It corresponds to the legacy |FM|. This is the only kind of ``FIELD_MAP``
    currently supported by :class:`.Envelope1D` (although 1D static electric
    field could also be implemented).
