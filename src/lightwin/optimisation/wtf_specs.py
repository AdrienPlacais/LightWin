...
WTF_COMMON = (
    ...
    KeyValConfSpec(
        ...
        types=(int,),
        description=(\
                     """Specify whether user-provided cavity indices are
                     0-based or 1-based.

                     Set `0` if the first cavity has index 0 (Python-style,
                     default). Set `1` if the first cavity has index 1 (human-
                     friendly). This affects how the `failed` and
