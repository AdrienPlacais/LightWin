...
import lightwin.config.evaluators
import lightwin.config.files
import lightwin.config.plots
...
def _process_config(
    ...
    associated_modules = {
        "files": lightwin.config.files,
        "plots": lightwin.config.plots,
        "beam_calculator": lightwin.config.beam_calculator,
        "beam": lightwin.config.beam,
        "wtf": lightwin.config.wtf,
        "design_space": lightwin.config.design_space,
        "beam_calculator_post": lightwin.config.beam_calculator,
        "evaluators": lightwin.config.evaluators,
    }
